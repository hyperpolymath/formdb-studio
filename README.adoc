...
// SPDX-FileCopyrightText: 2025 hyperpolymath= FormDB Studio
:toc: macro
:toc-title: Contents
:toclevels: 3
:icons: font
...
FormDB Studio is a graphical interface that lets non-technical users create and query FormDB databases using FQLdt (dependently-typed FormDB Query Language) without needing to understand dependent types, proofs, or Lean 4.
...
See https://github.com/hyperpolymath/formdb/blob/main/spec/self-normalizing.adoc[FormDB Self-Normalizing Spec] and https://github.com/hyperpolymath/fqldt/blob/main/spec/normalization-types.md[FQLdt Normalization Types].
...
* **Lean 4** (for FQLdt type checking) - https://leanprover.github.io/lean4/doc/setup.html
...
| Binary
| `src-tauri/target/release/formdb-studio`

| Debian package
| `src-tauri/target/release/bundle/deb/FormDB Studio_*.deb`

| RPM package
| `src-tauri/target/release/bundle/rpm/FormDB Studio-*.rpm`
|===
...
│   ├── FqldtPreview.res    # Live FQLdt code preview
...
* [x] FQLdt code generation (client-side)
* [ ] Basic proof automation (awaiting FQLdt M5)
...
* [ ] Result preview (awaiting FormDB M11)
* [ ] Query history
...
* [ ] Backend integration (awaiting FormDB M11)
* [ ] Bulk import
...
* [ ] Backend integration (awaiting FormDB M11)
* [ ] FQLdt proof integration for schema changes

=== Blocking Dependencies

* **FormDB M11** - HTTP API Server (required for database operations)
* **FQLdt M5** - Zig FFI (required for real type checking)

== Related Projects

* https://github.com/hyperpolymath/formdb[FormDB] - The narrative-first database
* https://github.com/hyperpolymath/formdb/blob/main/spec/self-normalizing.adoc[FormDB Self-Normalizing] - Automatic FD discovery and proof-carrying schema evolution
* https://github.com/hyperpolymath/fqldt[FQLdt] - Dependently-typed Form Query Language
* https://github.com/hyperpolymath/fqldt/blob/main/spec/normalization-types.md[FQLdt Normalization Types] - Type-encoded functional dependencies and normal forms
* https://github.com/hyperpolymath/bofig[BoFIG] - Evidence graph for investigative journalism
* https://github.com/hyperpolymath/zotero-formdb[Zotero-FormDB] - Production pilot: reference manager with PROMPT scores
