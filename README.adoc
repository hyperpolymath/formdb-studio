...
See https://github.com/hyperpolymath/formbd/blob/main/spec/self-normalizing.adoc[FormBD Self-Normalizing Spec] and https://github.com/hyperpolymath/fbqldt/blob/main/spec/normalization-types.md[FBQLdt Normalization Types].
...
| Binary
| `src-tauri/target/release/formbd-studio`
...
* https://github.com/hyperpolymath/formbd[FormBD] - The narrative-first database
* https://github.com/hyperpolymath/formbd/blob/main/spec/self-normalizing.adoc[FormBD Self-Normalizing] - Automatic FD discovery and proof-carrying schema evolution
* https://github.com/hyperpolymath/fbqldt[FBQLdt] - Dependently-typed Form Query Language
* https://github.com/hyperpolymath/fbqldt/blob/main/spec/normalization-types.md[FBQLdt Normalization Types] - Type-encoded functional dependencies and normal forms
* https://github.com/hyperpolymath/bofig[BoFIG] - Evidence graph for investigative journalism
* https://github.com/hyperpolymath/zotero-formbd[Zotero-FormBD] - Production pilot: reference manager with PROMPT scores
* https://github.com/hyperpolymath/formbd-debugger[FormBD Debugger] - Proof-carrying database debugger (Lean 4 + Idris 2)
